...
@section('content')
  <div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Book Update</h1>
        ...
        <div class="card-body">
            <form action="{{route('books.update')}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea name="bookDescription" rows="10" class="form-control w-50 @error('bookDescription') is-invalid @enderror" id="description">{{old('bookDescription')}}</textarea>
